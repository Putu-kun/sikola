...
mysqli_select_db($konek, $database);
    echo "<h3>Soal Ujian Tengah Semester</h3>
    <pre>
    <br><br>
Kode Ujian           :
Nama Mata Pelajaran  :
...
echo "<div style='width:100%; border: 1px solid #EBEBEB; overflow:scroll;height:700px;'>";
 echo '<table width="100%" border="0">';
        ...
        $hasil=mysqli_query($konek, "select * from tbl_soal WHERE jurusan='IPS' ORDER BY RAND ()");
        ...
        while($row =mysqli_fetch_array($hasil))
        {
            ...
            ?>
<form name="form1" method="post"  action="<?php echo base_url().'index.php/welcome/aksi_tambah_jawaban'; ?>" >
