   ...
   <div class="container-fluid">
		...
		<?php 
			...
			<tr>
				...
				<td> </td>
				<td> </td>
				<td><a href="<?php echo base_url('index.php/welcome/soaluasips');?>"  class="btn btn-primary">Mulai&nbsp;&nbsp;Ujian </a></td>
			</tr>
            <?php } ?>
...
<?php 
			...
			$sql = mysqli_query($koneksi,"select * from mapel where jurusan='IPS' limit 1,10 ");
